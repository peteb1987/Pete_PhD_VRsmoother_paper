...
\begin{figure}[!t]
\centering
\subfloat[]{\includegraphics[width=0.45\columnwidth]{finance_value_rmse.pdf}} \\
\subfloat[]{\includegraphics[width=0.45\columnwidth]{finance_trend_rmse.pdf}}
...
\begin{figure}[!t]
\centering
\subfloat[]{\includegraphics[width=0.45\columnwidth]{tracking_pos_rmse.pdf}} \\
\subfloat[]{\includegraphics[width=0.45\columnwidth]{tracking_vel_rmse.pdf}}

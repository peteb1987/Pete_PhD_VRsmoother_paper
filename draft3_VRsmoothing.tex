...
This model may be discretised at the observation times using standard methods (see e.g. \cite{Grewal2002}), leading to,
%
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.9\columnwidth]{finance_unique_particles.pdf}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.9\columnwidth]{tracking_unique_particles.pdf}
